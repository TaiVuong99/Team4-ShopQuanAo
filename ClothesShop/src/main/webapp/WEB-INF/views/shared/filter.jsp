	...
	<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
		<div class="filter-col1 p-r-15 p-b-27">
			<div class="mtext-102 cl2 p-b-15">Lọc theo</div>
				<ul>
					<li class="p-b-6"><a href="" class="filter-link stext-106 trans-04">Tất cả</a></li>
					<li class="p-b-6"><a href="" class="filter-link stext-106 trans-04">Phổ biến</a></li>
					<li class="p-b-6"><a href="" class="filter-link stext-106 trans-04">Đánh giá</a></li>
					...
					<li class="p-b-6"><a href="" class="filter-link stext-106 trans-04">Giá: Cao xuống thấp</a></li>
				</ul>
			</div>
			...
			<div class="filter-col2 p-r-15 p-b-27">
				<div class="mtext-102 cl2 p-b-15">Giá</div>
					<ul>
						...
						<li class="p-b-6"><a href="" class="filter-link stext-106 trans-04">10 - 30</a></li>
						<li class="p-b-6"><a href="" class="filter-link stext-106 trans-04">30 - 50</a></li>
						<li class="p-b-6"><a href="" class="filter-link stext-106 trans-04">50 - 100</a></li>
						<li class="p-b-6"><a href="" class="filter-link stext-106 trans-04">100 - 300</a></li>
						<li class="p-b-6"><a href="" class="filter-link stext-106 trans-04">300+</a></li>
					</ul>
			</div>
			...
			<div class="filter-col4 p-b-27">
				<div class="mtext-102 cl2 p-b-15">Thẻ</div>
