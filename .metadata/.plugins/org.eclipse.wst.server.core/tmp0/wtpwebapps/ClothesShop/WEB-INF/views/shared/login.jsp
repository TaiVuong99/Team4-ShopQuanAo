      ...
      <div class="modal-c-tabs">
        ...
        <div class="tab-content">
          <div class="tab-pane fade in show active" id="panel7" role="tabpanel">
			<form id= "form-login" action="requestlogin" method="get">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-outline-info waves-effect ml-auto" id="login-close-btn" data-dismiss="modal">Close</button>
            </div>
		</div>
